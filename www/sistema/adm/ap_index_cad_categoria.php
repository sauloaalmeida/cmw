...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_acao_categoria.php'; ?></td></tr>
  <tr>
     <td width="780" align="center" valign="top"><?php include 'ap_cad_categoria.php'; ?></td>
  </tr>
</table>
</body>
</html>
