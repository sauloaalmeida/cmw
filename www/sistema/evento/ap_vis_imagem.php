...
//testa se o nome do arquivo veio
    if( !isset($_REQUEST["l_str_arquivo"]) )
        msg(K_MSGERRO, K_FECHAR, "Falta de parametros", "O par&acirc;metro l_str_arquivo n&atilde;o foi postado para a p&aacute;gina<br><br>Clique em fechar e tente novament se o problema persistir contate o administrador!");
...
<table width="90%" height="80%" border="0" align="center">
	<tr>
		<td align="center"><img src="<?php echo K_UPLOADDIR_EXIB_IMG_EVEN . $_REQUEST["l_str_arquivo"]; ?>"></td>
	</tr>
	<tr>
		<td align="center">
