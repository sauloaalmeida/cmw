...
if(!isset($_REQUEST["l_str_acao"]))
     msg(K_MSGERRO, K_VOLTAR, "Falta de par&acirc;metros", "O par&acirc;metro l_str_acao n&atilde;o foi postados para a p&aacute;gina<br><br>Clique em voltar e tente novament se o problema persistir contate o administrador!");
...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_acao_evento.php'; ?></td></tr>
  <tr>
     <td valign="top">
	    <?php include 'ap_cad_evento.php'; ?>
	 </td>
  </tr>
</table>
</body>
