...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_inscricao.php'; ?></td></tr>
  <tr>
     <td valign="top"><?php include 'ap_lst_inscricao.php'; ?></td>
  </tr>
</table>
</body>
</html>
