   ...
   <table width="530" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" colspan="5">
          <input type="button" value="Cadastrar Anexo" class="botao01" onClick="GoTo('ap_index_cad_anexo.php?news_not_pk=<?php echo $news_not_pk ?>&l_str_acao=<?php echo K_INCLUIR ?>&news_cat_pk=<?php echo $news_cat_pk ?>')">
    ...
    $RSanexos = $l_obj_noticia->getListaAnexos($news_not_pk);

   //verifica se existe algum registro no recordset
   if(!$l_obj_noticia->dbconn->getExisteRecordset($RSanexos)){
     ...
     while ( $RStemp = $l_obj_noticia->dbconn->getRecordsetArray($RSanexos) ) { ?>

       <tr>
	   <td><?php echo substr($RStemp["news_anx_titulo"],0,30); if(strlen($RStemp["news_anx_titulo"]) > 30) echo "..."; ?></td>
	   <td><?php echo substr($RStemp["news_anx_descricao"],0,30); if(strlen($RStemp["news_anx_descricao"]) > 30) echo "..."; ?></td>
	   <td width="20" align="center"><a href="ap_index_cad_anexo.php?l_str_acao=<?php echo K_CONSULTAR ?>&news_anx_pk=<?php echo $RStemp["news_anx_pk"] ?>&news_cat_pk=<?php echo $news_cat_pk ?>&news_not_pk=<?php echo $news_not_pk ?>"><img src="../nucleo/imgs/bt_consultar.gif" border="0" alt="Consultar anexo"></a></td>
	   <td width="25" align="center"><a href="ap_index_cad_anexo.php?l_str_acao=<?php echo K_ALTERAR ?>&news_anx_pk=<?php echo $RStemp["news_anx_pk"] ?>&news_cat_pk=<?php echo $news_cat_pk ?>&news_not_pk=<?php echo $news_not_pk ?>"><img src="../nucleo/imgs/bt_alterar.gif" border="0" alt="Alterar anexo"></a></td>
	   <td width="25" align="center"><a href="ap_index_cad_anexo.php?l_str_acao=<?php echo K_EXCLUIR ?>&news_anx_pk=<?php echo $RStemp["news_anx_pk"] ?>&news_cat_pk=<?php echo $news_cat_pk ?>&news_not_pk=<?php echo $news_not_pk ?>"><img src="../nucleo/imgs/bt_excluir.gif" border="0" alt="Excluir anexo"></a></td>
	   <tr>
