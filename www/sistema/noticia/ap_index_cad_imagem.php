...
if(!isset($_REQUEST["news_cat_pk"]) || !isset($_REQUEST["l_str_acao"]) || !isset($_REQUEST["news_not_pk"]) )
     msg(K_MSGERRO, K_VOLTAR, "Falta de parametros", "Alguns parâmetros necessários não foram postados para a pagina<br><br>Clique em voltar e tente novament se o problema persistir contate o administrador!");
...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_acao_imagem.php'; ?></td></tr>
  <tr>
     <td valign="top"><?php include 'ap_cad_imagem.php'; ?></td>
  </tr>
</table>
</body>
</html>
