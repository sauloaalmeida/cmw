...
<?php 
if(!isset($_REQUEST["enq_cat_pk"]) || !isset($_REQUEST["enq_enq_pk"]))
...
//instancia objeto de noticia para pegar a categoria da enquete
...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_resposta.php'; ?></td></tr>
  <tr>
     <td valign="top"><?php include 'ap_lst_resposta.php'; ?></td>
  </tr>
</table>
</body>
</html>
