...
if(!isset($_REQUEST["enq_cat_pk"]) || !isset($_REQUEST["l_str_acao"]) || !isset($_REQUEST["enq_enq_pk"]))
...
<table width="100%" height="100%" border="0">
  ...
  <tr><td height="15" valign="bottom" id="rastro"><?php include 'inc_local_acao_resposta.php'; ?></td></tr>
  <tr>
     <td valign="top">
	    <?php include 'ap_cad_resposta.php'; ?>
	 </td>
  </tr>
</table>
</body>
