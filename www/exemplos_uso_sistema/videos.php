...
if(isset($_REQUEST["news_not_pk"])){
    ...
    $l_obj_noticia->GetNoticia($news_not_pk);
     ...
     $rsDestaqueNoticia = $l_obj_noticia->GetDestaque1(K_CAT_VIDEOS, K_IDI_PORTUGUES);
       ...
       <?php
        ...
        ?>
                <div style="margin-bottom:15px;"><h4><?php echo $rsTempAnexos["news_anx_titulo"]; ?> </h4>
                    <?php echo $rsTempAnexos["news_anx_descricao"];?>
                    <a href="javascript:void(0);" onClick="javascript:window.open('pop_video.php?news_anx_pk=<?php echo $rsTempAnexos["news_anx_pk"]; ?>','videos','height=400,width=310,left=100,top=100')">Assista o Vídeo</a>&nbsp;(<?php echo $rsTempAnexos["tipo_anx_nome"]; ?>)
                </div>
        <?php
            }
       ?>
